...
describe('computeCampaignPlan (aperçu, pur)', () => {
  ...
  it('appelle un lot vacant, dérive le redevable, ignore un lot déjà appelé', () => {
    const plan = computeCampaignPlan({
      ...base,
      lots: [
        { id: 'a', reference: 'A1', type: 'APPARTEMENT', monthlyChargeMinor: 65000 },
        { id: 'v', reference: 'V1', type: 'VILLA', monthlyChargeMinor: 0 }, // vacant → défaut villa
        { id: 'x', reference: 'A2', type: 'APPARTEMENT', monthlyChargeMinor: 65000 }, // déjà appelé
      ],
